...
- 段落补词：按 2026 TOEFL `Complete the Words` 形式补全单词后半部分。
...
- 无需 API：图片 OCR、文本/PDF/DOCX 导入、候选词提取、4,127 词本地词库、已有本地发音、五种训练模式、本机存档和 JSON 备份。
- 需要 DeepSeek：只在本地词库没有某个词、需要生成完整双语词条时调用。
